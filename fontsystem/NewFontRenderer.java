...
public class NewFontRenderer {
	...
	public NewFontRenderer(Font font) {
	...
	//    this.kerning = kerning;
	    ...
	    String abc = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ&0123456789";
		FONT_HEIGHT = unicodeFont.getHeight(abc) / 2;
	...
	public float drawCenteredString(String text, float x, float y, int color) {
	    return drawString(text, x - (int)getWidth(text) / 2, y, color);
	}
